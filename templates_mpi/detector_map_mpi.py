...
# Get wave_vector
wavelength_exists = arsenal.util.get_wavelength_m(photon_energy_ev=photon_energy_exists)
wavevector_exists = np.array([0, 0, np.pi * 2 / wavelength_exists])

# Get pixel position in reciprocal space
pixel_momentum_exists_1d = arsenal.physics.get_scattered_momentum(position_in_meter=pixel_position_exists_1d,
...
# Get wavevector
wavelength_desired = arsenal.util.get_wavelength_m(photon_energy_ev=photon_energy_desired)
wavevector_desired = np.array([0, 0, 2 * np.pi / wavelength_desired])

# Get pixel position in reciprocal space
pixel_momentum_desired_1d = arsenal.physics.get_scattered_momentum(position_in_meter=pixel_position_desired_1d,
...
index_map_job, weight_map_job = ag.py_get_nearest_point_index_and_weight_3d(point_list_ref=pixel_momentum_desired_1d,
